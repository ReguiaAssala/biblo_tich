...
CREATE TABLE IF NOT EXISTS utilisateurs (
  ...
  role          ENUM('etudiant','admin','moderateur') DEFAULT 'etudiant',
...
('Electronique',           'electronique',        'Microélectronique, Systèmes embarqués, Robotique...',         'fas fa-microchip',       '#8e44ad'),
...
('Electrotechnique',       'electrotechnique',    'Machines Électriques, Réseaux électriques...',               'fas fa-bolt',            '#d68910'),
...
-- ════════════════════════════════════════════════════
-- DONNÉES: MODULES — INFORMATIQUE (id=5, 36 modules)
-- ════════════════════════════════════════════════════
INSERT INTO modules (specialite_id, nom, slug, niveau) VALUES
...
(5, 'Electronique Numérique',         'electronique-numerique','L1'),
...
(5, 'Analyse et Conception SI',       'analyse-conception',    'L3'),
...
(5, 'Sujets Doctorat Informatique',   'sujets-doctorat',       'Doctorat');

-- ════════════════════════════════════════════════════
-- DONNÉES: MODULES — MEDECINE (id=1)
-- ════════════════════════════════════════════════════
INSERT INTO modules (specialite_id, nom, slug, niveau) VALUES
(1, 'Anatomie',            'anatomie',          'L1'),
(1, 'Biochimie Médicale',  'biochimie-med',     'L1'),
(1, 'Histologie',          'histologie',        'L1'),
(1, 'Physiologie',         'physiologie',       'L2'),
(1, 'Pharmacologie',       'pharmacologie-med', 'L3'),
(1, 'Sémiologie',          'semiologie',        'L3'),
(1, 'Cardiologie',         'cardiologie',       'M1'),
(1, 'Neurologie',          'neurologie',        'M1'),
(1, 'Pédiatrie',           'pediatrie',         'M2'),
(1, 'Chirurgie Générale',  'chirurgie',         'M2');

-- ════════════════════════════════════════════════════
-- DONNÉES: MODULES — GENIE CIVIL (id=10)
-- ════════════════════════════════════════════════════
INSERT INTO modules (specialite_id, nom, slug, niveau) VALUES
...
('Admin', 'Bibliothèque', 'admin@biblio-dz.com',
 '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TiGVyMbPJh7X5e8Z9DpQwA1NvKY2',
 'admin');
...
SELECT COUNT(*) AS users_count FROM utilisateurs;
